  ...
  return (
    <>
      ...
      >
        ...
        {/* Filters row: type pills + status select */}
        ...
        {paginated.length > 0 ? (
          <div className="overflow-hidden rounded-lg border border-border">
            ...
            <div className="flex items-center gap-4 border-b border-border bg-secondary/50 px-4 py-2.5">
              ...
              <span className="w-28 shrink-0 text-right text-[11px] font-medium uppercase tracking-wide text-muted-foreground">
                Actions
              </span>
            </div>
