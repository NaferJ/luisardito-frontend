  ...
  return (
    <div className="flex items-center gap-1.5 font-mono text-[13px] text-muted-foreground">
      <span className="relative flex size-1.5">
        <span aria-hidden="true" className="absolute inset-0 animate-ping rounded-full bg-gold opacity-60" />
        <span aria-hidden="true" className="relative size-1.5 rounded-full bg-gold" />
      </span>
