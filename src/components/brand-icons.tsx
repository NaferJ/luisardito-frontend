/** Brand logo icons for Kick and Discord.
...
export function KickLogo({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M3 3h5v5h1V5h1V3h5v5h-1v2h-1v1h2v-1h1V8h1V3h5v18h-5v-5h-1v-2h-1v-1h-2v1h1v2h1v5H8v-5H7v-2H6v-1H4v1H3v2H2v5H3V3z" />
    </svg>
  )
}
