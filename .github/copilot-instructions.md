# Copilot custom instructions — luisardito-frontend
...
in this repository. Keep this file in sync with `.devin/rules/luisardito-frontend.md`
and `.windsurf/rules.md` — they encode the same house rules for different tools.
